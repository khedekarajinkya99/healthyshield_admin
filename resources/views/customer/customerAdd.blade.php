					...
					<div class="col-lg-6">
						...
						<div class="card-style mb-30">
                            ...
                            <div class="input-style-1">
								...
								<input type="password" placeholder="Customer Password" name="password" required autocomplete="off" />
							</div>
							@error('password')
	                          <div class="alert alert-danger" role="alert">{{ $message }}</div>
	                        @enderror
                            ...
                            <div class="input-style-1">
								...
								<input type="number" placeholder="Customer Number" name="customer_contact" required autocomplete="off" />
							</div>
                            ...
                            <div class="input-style-1">
								...
								<textarea rows=5 name="customer_address" required></textarea>
							</div>
                            ...
                            <div class="input-style-1">
								...
								<input type="date" placeholder="Customer Date Of Birth" name="customer_dob" required autocomplete="off" />
							</div>
							@error('customer_dob')
	                          <div class="alert alert-danger" role="alert">{{ $message }}</div>
	                        @enderror
